...
<div class="row">
    <div class="col-md-6" style="direction: rtl">
        <div class="card h-400px" dir="ltr">
            <div class="card-body d-flex flex-column flex-center">
                <div class="mb-2">
                    <h1 class="fw-semibold text-gray-800 text-center lh-lg">Annual Report</h1>
                ...
                <div class="text-center mb-1">
                    <a href="/reports/generate" class="btn btn-sm btn-primary me-2">Generate Annual Report</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-6" style="direction: rtl">
        <div class="card h-400px" dir="ltr">
            <div class="card-body d-flex flex-column flex-center">
                <div class="mb-2">
                    <h1 class="fw-semibold text-gray-800 text-center lh-lg">Weekly Project Report</h1>
                    <div class="py-10 text-center">
                ...
                <div class="text-center mb-1">
                    <button type="button" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" 
                        data-bs-target="#weeklyReport">Generate Weekly Project Report</button>
                </div>
            </div>
        </div>
