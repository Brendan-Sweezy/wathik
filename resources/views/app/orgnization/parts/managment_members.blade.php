<div class="card card-flush h-xl-100" dir="rtl">
    ...
    <div class="card-body pt-1">
        <table class="table align-middle table-row-dashed fs-6 gy-5" dir="rtl">
                ...
                <td class="text-start">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                        ...
                        <div class="menu-item px-3">
                            <a href="{{ url('orgnization/managment/members/amendMember/' . $member->id) }}" data-bs-toggle="modal" data-bs-target="#editMember"
            ...
            <div class="modal fade" id="editMember" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <div class="modal-content">
