        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" dir="rtl">
            <thead>
                <tr class="text-end text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">تاریخ التسجیل</th>
                    <th class="min-w-125px">اسم الفرع</th>
                    <th class="min-w-125px">المحافظة</th>
                    <th class="min-w-125px">اللواء</th>
                    <th class="min-w-125px">القضاء</th>
                    <th class="min-w-125px">التجمع السكاني</th>
