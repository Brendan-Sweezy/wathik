                        ...
                        <div class="stepper-nav">
                            ...
                            <div class="stepper-item current" data-kt-stepper-element="nav">
                                ...
                                <div class="stepper-wrapper">
                                    ...
                                    <div class="stepper-label">
                                        <h3 class="stepper-title fs-2">معلومات الجمعية</h3>
                                    </div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Wrapper-->
                            ...
                            <div class="stepper-item" data-kt-stepper-element="nav">
                                ...
                                <div class="stepper-wrapper">
                                    ...
                                    <!--begin::Label-->
                                    <div class="stepper-label">
                                        <h3 class="stepper-title fs-2">معلومات التواصل</h3>
                                    </div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Wrapper-->
                            ...
                            <div class="stepper-item" data-kt-stepper-element="nav">
                                ...
                                <div class="stepper-wrapper">
                                    ...
                                    <!--begin::Label-->
                                    <div class="stepper-label">
                                        <h3 class="stepper-title fs-2">العنوان</h3>
                                    </div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Wrapper-->
                            ...
                            <div class="stepper-item" data-kt-stepper-element="nav">
                                ...
                                <div class="stepper-wrapper">
                                    ...
                                    <!--begin::Label-->
                                    <div class="stepper-label">
                                        <h3 class="stepper-title">مدير الجمعية</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    <div class="w-lg-650px w-xl-700px p-10 p-lg-15 mx-auto">
                        <form class="my-auto pb-5" novalidate="novalidate" id="kt_create_account_form" method="POST"
                            action="{{ url('saveWizard') }}" style="direction: rtl">
                            @include('app.wizard.info')
                            @include('app.wizard.contact')
                            @include('app.wizard.address')
                            @include('app.wizard.manager')
                            <div class="d-flex flex-stack pt-15">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-lg btn-primary"
                                        data-kt-stepper-action="next">متابعة
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
